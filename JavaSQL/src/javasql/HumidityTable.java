...
public class HumidityTable {
    ...
    public HumidityTable(String query){
        JFrame frame = new JFrame("Humidity by Date");
        
        String column[]={"Log_ID_PK", "Date_of_Log", "Time_of_Log", "Humidity (g.kg-1)"};
        ...
        try{
            ...
            while(rs.next()){
                ...
                humidity = Float.toString(rs.getFloat("Humidity"));
                Object[] data = {logid, date, time, humidity};
