...
public class PressureMenu {
    ...
    public PressureMenu(){
        String queryTemplate = "SELECT Log_ID_PK, Date_of_Log, Time_of_Log, Pressure FROM datalogs WHERE Date_of_Log=";
        String averageQueryTemplate = "SELECT Pressure FROM datalogs WHERE Date_of_Log=";
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");  
        
        JFrame pressMenu = new JFrame("Pressure Menu");
        
        JPanel titlePanel = new JPanel();
        titlePanel.setBounds(2, 0, 410, 50);
        Color titlePanelBG = new Color(153,255,153);
        titlePanel.setBackground(titlePanelBG);
        JLabel title = new JLabel("Pressure Menu");
        title.setFont(new Font("Serif", Font.BOLD, 36));
        titlePanel.add(title);
        
        pressMenu.add(titlePanel);
        ...
        searchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(dateField.getDate() == null){
                    ...
                    PressureTable pressureTable = new PressureTable(finalQuery);
                }
            }
        });
        ...
        averageButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(dateField.getDate() == null){
                    ...
                    averageTextPane.setText(String.valueOf(getAveragePressureForDate(finalAverageQuery)));
                }
            }
        });
        ...
        pressMenu.add(contentPanel);
        
        pressMenu.setSize(429,250);
        pressMenu.setLayout(null);
        pressMenu.setResizable(false);
        pressMenu.setVisible(true);
    }
    
    private float getAveragePressureForDate(String query){
